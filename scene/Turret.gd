...
func _ready():
	...
	$Head/Vision_Area.connect("body_entered", self, "body_entered_vision")
	$Head/Vision_Area.connect("body_exited", self, "body_exited_vision")
	...
	node_raycast.add_exception($Head/Vision_Area)
